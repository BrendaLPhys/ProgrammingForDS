...
```
    ...
    7437 as our personal assistants who can take care of many things
    on our behalf.  The hardware in our current-day computers 
    is essentially built to continuously ask us the question, 
    What would you like me to do next?
    
    Programmers add an operating system and a set of applications
    5944 to the hardware and we end up with a Personal Digital
    4053 Assistant that is quite helpful and capable of helping 9011
    ...
    for you to do the 
    2862 things that you are uniquely suited for.  You bring 
    ...
    1787 For now, our primary motivation is not to make money or please end users, but
    instead for us to be more productive in handling the data and 
    1628 information that we will encounter in our lives. 9782
    ...
    8813 programming feels more creative to you, your thoughts may turn 4757
    ...
    7154 develop software, we need to learn a small amount about 
    ...
    9673 The advantage of the secondary memory is that it can 7812
    ...
    936 of writing these instructions down and getting the instructions to 
    be correct programming.
    
    Understanding programming
    9458  8396
    4126 In the rest of this book, we will try to turn you into a person
    9641 who is skilled in the art of programming.  In the end you will be a 212
    ...
    2147 you need to know the vocabulary and the grammar.  You need to be able 
    ...
    I 1135 wish 2975 more 6705 people would walk to improve their overall health, 
    ...
    1131 as        elif      global    or        with 9537
    ...
    And 997 we 6872 have 715 even written our first syntactically correct Python sentence.
     Our sentence starts with the reserved word print followed
    1335 by a string of text of our choosing enclosed in single quotes. 2015
    ...
    4839 on Macintosh and Windows systems.  At some point, you will be in 1021
    ...
    5002 put you on a spit, roast you over a fire, and eat you for dinner.
    ...
    interpreter, 3152 you 9346 should 2267 probably know the proper way
    ...
    2872 straightforward for humans to read and write and for computers 8761
    ...
    4197 is represented all in zeros and ones. 8526
    
    Machine language seems quite simple on the surface, given that there 
    are only zeros and ones, but its syntax is even more complex
    4425 and far more intricate than Python.  So very few programmers ever write 7133
    ...
    and 3894 these 4357 translators 8545 convert the programs to machine language for actual
    ...
    so 5766 we 6504 can 5646 retrieve the value later.   We verify that Python has actually remembered
    ...
    3224 as shown above.  A compiler needs to be handed the entire program in a file, and then 8067
    ...
    2117 languages like Python or C. 9940
    2489 227 8300
    Now 8816 at 6255 this 9451 point in our discussion of compilers and interpreters, you should 
    ...
    5432 You can look at the actual source code for the Python interpreter by
    ...
    To 8556 execute 5481 the 7966 script, you have to tell the Python interpreter 
     the name of the file.  In a Unix or Windows command window, 
    you would type python hello.py as follows:
    
    103 We call the Python interpreter and tell it to read its source code from
